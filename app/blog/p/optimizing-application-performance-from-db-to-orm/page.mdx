...
export const metadata = createArticleMetadata(
  getBlogPostSeoInput('optimizing-application-performance-from-db-to-orm')
)

<JsonLd data={buildArticleSchema(getBlogPostSeoInput('optimizing-application-performance-from-db-to-orm'))} />
<Cover
