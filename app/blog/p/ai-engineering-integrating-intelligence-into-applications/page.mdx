...
export const metadata = createArticleMetadata(
  getBlogPostSeoInput('ai-engineering-integrating-intelligence-into-applications')
)

<JsonLd data={buildArticleSchema(getBlogPostSeoInput('ai-engineering-integrating-intelligence-into-applications'))} />
<Cover
