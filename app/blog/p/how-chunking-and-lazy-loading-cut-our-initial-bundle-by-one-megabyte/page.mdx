...
```
vendor-react      163 KB   ← Core runtime (cached long-term)
vendor-editor     358 KB   ← Rich-text (only career page builder)
vendor-charts     290 KB   ← Charts (only reports)
route-candidates  157 KB   ← Candidates feature module
route-career-page 221 KB   ← Career page builder
vendor-lazy       450 KB   ← Lazy-loaded export and file handling
```
