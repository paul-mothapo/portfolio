...
export const metadata = createArticleMetadata(
  getBlogPostSeoInput('exploring-best-practices-of-software-design')
)

<JsonLd data={buildArticleSchema(getBlogPostSeoInput('exploring-best-practices-of-software-design'))} />
<Cover
