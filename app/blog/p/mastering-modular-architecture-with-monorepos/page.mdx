...
export const metadata = createArticleMetadata(
  getBlogPostSeoInput('mastering-modular-architecture-with-monorepos')
)

<JsonLd data={buildArticleSchema(getBlogPostSeoInput('mastering-modular-architecture-with-monorepos'))} />
<Cover
