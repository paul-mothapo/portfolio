...
export const metadata = createArticleMetadata(
  getBlogPostSeoInput('what-limits-the-growth-of-a-product')
)

<JsonLd data={buildArticleSchema(getBlogPostSeoInput('what-limits-the-growth-of-a-product'))} />
<Cover
  src="https://images.unsplash.com/photo-1659302615162-4bc8bb0e3e84?q=80&w=2021&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
  alt="3D Render of an abstract rock composition - from unsplash.com"
  caption="3D Render of an abstract rock composition - from unsplash.com"
/>
